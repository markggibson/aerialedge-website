---
title: "Can you get flexible in your 50s, 60s and 70s?"
date: 2026-06-25
author: Aerial Edge
categories:
  - Circus Training
tags:
  ...
  - flexibility
  - older adults
excerpt: "Can you get flexible in your 50s, 60s or 70s? Yes. Age slows the climb and lengthens recovery, but it doesn't lower the ceiling. Older adults build real range."
---
...
If you have read this far wondering whether a class would actually have room for someone your age, ours do. Our adult classes are built to start beginners where they are, and older beginners are welcome in them. Our [adult classes](https://aerialedge.co.uk/portfolio/circus-fitness/) are a good place to start.
...
- Recovery from Resistance Exercise in Older Adults: a systematic scoping review, *Sports Medicine - Open* 2023 (https://link.springer.com/article/10.1186/s40798-023-00597-1); masters-athlete recovery study, JSAMS (https://www.jsams.org/article/S1440-2440(19)31101-6/abstract). Recovery from muscle-damaging work runs longer with age, as a tendency, partly offset by training status. Direction only; magnitude has no consensus.
- Currier BS, D'Souza AC, Fiatarone Singh MA, et al. (2026). American College of Sports Medicine Position Stand: Resistance Training Prescription for Muscle Function, Hypertrophy, and Physical Performance in Healthy Adults. *Medicine & Science in Sports & Exercise* 58(4):851–872 (PMID 41843416). Direction only: resistance training is safe across the adult age range; keep strength and power work, leave reps in reserve. (The abstract scopes to healthy adults ≥18; the older-adult specifics are direction-only, not a primary-confirmed older-adult number.)
- Tendon-adaptation research in older adults: "Effect of aging and exercise on the tendon" (J Appl Physiol review 2016, https://journals.physiology.org/doi/full/10.1152/japplphysiol.00328.2016); "Adaptability of elderly human muscles and tendons to increased loading" (PMC2100204, https://pmc.ncbi.nlm.nih.gov/articles/PMC2100204/). Older tendon still adapts, over a longer window, with sufficient load. Direction only.
- Royal Osteoporosis Society, "Strong, steady and straight" exercise recommendations for osteoporosis and bone health (reproduced via the Society for Endocrinology, https://www.endocrinology.org/endocrinologist/135-spring20/features/strong-steady-and-straight-exercise-recommendations-for-osteoporosis-and-bone-health/); narrative review on end-range hip movements in low bone density (PMC8606974, https://pmc.ncbi.nlm.nih.gov/articles/PMC8606974/). The flag is specifically loaded spinal flexion, not stretching in general; end-range hip work is not flagged.
